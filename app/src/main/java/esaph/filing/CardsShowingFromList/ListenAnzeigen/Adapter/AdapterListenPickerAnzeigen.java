package esaph.filing.CardsShowingFromList.ListenAnzeigen.Adapter;
...
public class AdapterListenPickerAnzeigen extends BaseAdapter implements Filterable
{
    ...
    public AdapterListenPickerAnzeigen(Context context, ListObserver adapterDataEmptyListener)
    {
